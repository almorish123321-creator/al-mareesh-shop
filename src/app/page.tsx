...
// تجنب SSR تماماً - الصفحة تُحمّل بالكامل على العميل
const HomeClient = dynamic(() => import('./home-client'), {
  ssr: false,
  loading: () => (
    <div className="min-h-screen bg-[#FFF9F5] flex flex-col items-center justify-center gap-4" dir="rtl">
      <div className="text-4xl font-bold text-[#8B1A4A]">المريش شوب</div>
      ...
      <p className="text-[#8B7355] text-sm">جاري التحميل...</p>
    </div>
  ),
});
